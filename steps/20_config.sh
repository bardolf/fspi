...
config_step_copy_collection \
  ...
  "$SCRIPT_DIR/config/swaylock/effects.conf" "$HOME/.config/swaylock/effects.conf" \
  ...
  "$SCRIPT_DIR/config/sway/config.d/50-rules-gaming.conf" "$HOME/.config/sway/config.d/50-rules-gaming.conf" \
  ...
  "$SCRIPT_DIR/config/sway/config.d/60-bindings-power.conf" "$HOME/.config/sway/config.d/60-bindings-power.conf" \
  ...
  "$SCRIPT_DIR/config/teams-for-linux/config.json" "$HOME/.var/app/com.github.IsmaelMartinez.teams_for_linux/config/teams-for-linux/config.json"
