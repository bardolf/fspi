...
CONFIG_PAIRS=(
  ...
  "config/sway/config.d/60-bindings-gamescale.conf" "$HOME/.config/sway/config.d/60-bindings-gamescale.conf"
  "config/sway/config.d/60-bindings-power.conf" "$HOME/.config/sway/config.d/60-bindings-power.conf"
